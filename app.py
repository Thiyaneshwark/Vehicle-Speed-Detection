...
UPLOAD_FOLDER = r"E:\spedd_project\Car-Speed-Detector\static\upload"
...
def gen():
    ...
    dataset_1 = cv2.CascadeClassifier(r"E:\spedd_project\Car-Speed-Detector\dataset\cars.xml")
    dataset_2 = cv2.CascadeClassifier(r"E:\spedd_project\Car-Speed-Detector\dataset\myhaar.xml")
    ...
    while True:
        ...
        if ret == True:
            ...
            if not (frame_counter % 10):
                ...
                with open(
                    r"E:\spedd_project\Car-Speed-Detector\dataset\vehicle.csv" and r"E:\spedd_project\Car-Speed-Detector\dataset\cars.csv", "a", newline=""
